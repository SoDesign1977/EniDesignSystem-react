    ...
    array.forEach((element) => {
      ...
      buffer.push(
        <li
          ...
          className={`${element.disabled ? "disabled" : ""} ${value.includes(element.value) ? "selected" : ""}`}
        >
  ...
  const CheckboxFilter = () => {
    ...
    return (
      <ul
        ...
        className={`eni-select-options ${open ? "eni-select-open" : "eni-select-close"} ${
  ...
  return (
    <>
      ...
      <div className="EniSelectWithUl">
        {/*INPUT LABEL*/}
        <div className="eni-select-container">
          <input
            {...props}
            ...
            minLength="1"
          ></input>
          <label className={`eni-input-label exp_elem ${value.length > 0 ? "valuefocus" : ""}`} htmlFor={id}>
            {title}
          </label>
          ...
          <div className={`eni-select `}>
            ...
            >
              <div className="eni-select-content">
                <span>
                  {value.map((el) => {
                    return `${el} `;
                  })}
